...
>
> Replace **32.26GB** with the value you used before, adding **0.1GB** to it
```cmd
mkpart esp fat32 32.16GB 32.26GB
```

#### Creating Windows partition
> Replace **32.26GB** with the end value of **esp**
>
> Replace **123GB** with the end value of your disk, use `p free` to find it
```cmd
mkpart win ntfs 32.26GB 123GB
```
